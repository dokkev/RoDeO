...
// Copyright (c) 2026
//
// Minimal hierarchy anchors for generic level-based WBMC.
//

#ifndef __wbc_controller_wbmc_hierarchy_policy_hpp__
#define __wbc_controller_wbmc_hierarchy_policy_hpp__
...
#endif  // ifndef __wbc_controller_wbmc_hierarchy_policy_hpp__
