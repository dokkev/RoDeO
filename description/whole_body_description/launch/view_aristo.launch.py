...
def generate_launch_description():
    ...
    joint8 = LaunchConfiguration("joint8")

    xacro_file = PathJoinSubstitution(
        [FindPackageShare("whole_body_description"), "urdf", "aristo.urdf.xacro"]
    )
    rviz_config = PathJoinSubstitution(
        [FindPackageShare("whole_body_description"), "rviz", "plato_world.rviz"]
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("joint2", default_value="0.0"),
            DeclareLaunchArgument("joint3", default_value="0.0"),
            DeclareLaunchArgument("joint4", default_value="0.0"),
            DeclareLaunchArgument("joint5", default_value="0.0"),
            DeclareLaunchArgument("joint6", default_value="0.0"),
            DeclareLaunchArgument("joint7", default_value="0.0"),
            DeclareLaunchArgument("joint8", default_value="0.0"),
            Node(
